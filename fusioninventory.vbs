...
'
'       SetupLocation = "\\127.0.0.1\c$\fusioninventory-agent_windows-x86_2.6.exe" or
'      SetupLocation = "\\127.0.0.1\c$\fusioninventory-agent_windows-x64_2.6.exe"
'
...
'
'SetupLocation = "https://github.com/fusioninventory/fusioninventory-agent/releases/tag/2.3.21" & SetupVersion
...
'
SetupOptions = "/acceptlicense /runnow /server='https://cgs.simmsolucoes.com.br/plugins/fusioninventory/' /S"
'SetupOptions = "/S /acceptlicense /no-start-menu /runnow /server='https://cgs.simmsolucoes.com.br/plugins/fusioninventory/' /add-firewall-exception /installtasks=Full /execmode=Service /httpd-trust='127.0.0.1,cgs.simmsolucoes.com.br/24
